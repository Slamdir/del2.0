...
begin
   ...
   declare
      ...
      Data_Shape     : constant Tensor_Shape_T := (1 => 1, 2 => 2);  -- e.g., single sample, 2 features
      Target_Shape   : constant Tensor_Shape_T := (1 => 1, 2 => 4);  -- e.g., single sample, 4 classes
   ...
   begin
      ...
      begin
         ...
         Linear_T(Layer1.all).Initialize(Input_Size  => 2,
                                         Output_Size => 4);
         ...
         -- call will internally load JSON from Json_Filename and shape it.
         -- JSON_parse_error 
