...
begin
   ...
   Test_Result := R.Forward(Positive_Input);
   ...
   Test_Result := R.Forward(Negative_Input);
   Assert_Test(Expected_Negative_Output, Test_Result, "ReLU Forward Negative Input");

   -- Add ReLU Layer to Network
   Put_Line("3. Adding ReLU Layer to Network");
   declare
   ...
   begin
      ...
      Assert_Test(Expected_Positive_Output, Network_Result, "Network ReLU Layer Test");
   end;
